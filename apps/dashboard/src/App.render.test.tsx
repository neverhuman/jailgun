...
it('renders the run header and per-tab rows', async () => {
  ...
  expect(screen.getByLabelText('tab 1 of 3 row')).toBeInTheDocument();
  expect(screen.getByLabelText('tab 2 of 3 row')).toBeInTheDocument();
  expect(screen.getByLabelText('tab 3 of 3 row')).toBeInTheDocument();
